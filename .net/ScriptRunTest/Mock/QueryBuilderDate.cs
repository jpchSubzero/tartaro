...
namespace ScriptRunTest.Mock
{
    ...
    {
        public static List<object> expenseData = new List<object>() {
                new { UniqueId= "T100001", DateTime= 1496288520000,
Category= "Food",
...
FormattedDate= "11/30/2017 02=42 PM"
        ...
        public static List<object> hardwareData = new List<object>() {
                new {
      TaskID= 1,
      Name= "Lenovo Yoga",
      Category= "Laptop",
