...
using eshop_api.Extensions;
using eshop_api.Interfaces;
using eshop_api.Middlewares;
using eshop_api.Repositories;
...
namespace eshop_api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Eship API", Version = "v1" });
            });
        }
